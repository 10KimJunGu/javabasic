...
public class Exam2 {
	...
	public static void main(String[] args) {
		...
		//일반적으로 반복문에서 특정조건을 만족하는 경우 반복문을 탈출하는데 사용된다.
...
//		}  // break로 탈출하게 되는 중괄호
		...
		// 꼭 기억해야하는 점은 break를 이용해 탈출하는 것은 if문을 제외한 가장 가까운 중괄호라는 것이다.
		// 따라서 만약 이중으로 중복된 for 문에서 break를 사용할 경우 안쪽 for문만 탈출하게된다.
...
//		
		...
		// j가 3이 되면 break로 탈출하게되는 반복문은 안쪽의 for이다.
		//탈출을 한 뒤에도 바깥쪽 for문 내부에 있기 때문에 i값의 변화에 따른 반복은 여전히 유효하게된다.
...
//		}
		...
		// break out은 out레이블이 위치해 있는 바깥쪽 for문을 완전히 탈출하라는 의미다.
...
//		
//		
//		// #1 레이블을 사용하여 i = 3, j = 2일때 이중 for문을 한번에 탈출하는 코드를 완성하시오.
//		out:
//		for(int i = 0; i < 10; i++) {
//			for(int j = 0; j < 5; j++) {
//				if(i==3 & j ==2) {
