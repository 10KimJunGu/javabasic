...
//		중괄호 안의 실행 구문을 반복적으로 실행하는 반복 제어문으로 조건을 만족하는동안 반복은 지속된다.
...
//	
	...
	//검사사하기때문에 1회는 반드시 실행된다.
	//마치 do~while문은 while문보다 1회 더 실행된다고 생각할 수도 있지만 절대 아니다.
...
//	}while(a<10);
	...
	//절대로  do~while문이 한번 더 실행 되는 것이 아니다.
