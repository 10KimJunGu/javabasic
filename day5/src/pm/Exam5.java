...
//		
//		//2 charAt() 문자열 검색
//		System.out.println(str1.charAt(1));  //index 1 위치의 문자를 검색
//		System.out.println(str2.charAt(1));  //index 2 위치의 문자를 검색
//		System.out.println();
//		
//		
//		//3 indexOf() 글자가 위치한 인덱스를 반환   /  lastIndexOf()
//		System.out.println(str1.indexOf('a'));  //앞에서부터 첫번째등장하는 'a'가 위치한 인덱스 반환
//		System.out.println(str1.lastIndexOf('a'));  //앞에서부터 첫번째등장하는 'a'가 위치한 인덱스 반환
//		System.out.println();
//		
//		
