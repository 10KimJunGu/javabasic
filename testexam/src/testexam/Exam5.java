...
public class Exam5 {
	...
	public static void main(String[] args) {
		...
		// 따라서 변수를 삭제하는 주체가 개발자가 아니기때문에 메모리에서 
		// 변수가 사라지는 시점을 이해하는 것은 중요하다.
		// 만약 사라진 변수값을 읽거나 값을 대입하려고 하면 문법 오류가 발생한다.
//			int value1 = 3; // 변수 value1이 생성되는
//			{
//				int value2 = 5; // 변수 value2가 생성
//				System.outprintln(value1);
//				System.outprintln(value2);
//			} // 변수 value2가 사라지는 지점
